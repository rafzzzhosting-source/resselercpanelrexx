...
// Configuration
const apikey = 'ptla_MhPn8KZ7CwJbdHARs6ZtM8Z4YllTFGOsve78S1IHuuL';
const capikey = 'ptlc_VASLkIFj4F7nuwIhcqsy2FT3poLdPgG2FmMspCkOWWd';
const domain = 'https://yang.tau.aja.server.new.public.lightsecretaja.web.id';
const nestid = '5';
const egg = '15';
const loc = '1';
const gmailadmin = 'rexx-sabtu18oktober@LIGHT.SECRET'; // Admin email that won't be deleted
const telegramBotToken = '8425072733:AAF9Go-_duJoh4go_eZN53hyWMwyT739Ewk';
const adminTelegramId = '8331405438';
...
app.post('/api/login', (req, res) => {
  ...
  if (username === 'resselerpanelrexx' && password === 'resselerpanelrexx') {
    res.json({ success: true, user: { username: 'resselerpanelrexx', role: 'admin' } });
  } else {
